...
const Fitur = () => {
  return (
    <div id="fitur" className="text-white bg-background">
      <div className="flex flex-col items-center justify-center h-full gap-8 py-20 mx-auto md:gap-16 max-w-7xl">
        <h1 className="py-8 text-4xl font-bold text-center md:text-5xl ">Funfact</h1>
        <div className="flex flex-col items-center w-[80%] mx-auto text-white bg-background gap-9 md:flex-row justify-evenly">
          <motion.div
          ...
          >
            <div className="flex items-center justify-center w-40 h-36 rounded-xl bg-surface">
              <ion-icon
                name="film-outline"
                className="items-center text-6xl text-blue-700"
